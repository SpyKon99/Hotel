...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
	<a class="navbar-brand" href="index.php">Hotel <i class="bi bi-code"></i></a>
...
// }
?>
<!-- <li class="nav-item"><a href="index.php" class="nav-link menu-item border-right mr-2"><i
						class="bi bi-shop"></i> Αρχική σελίδα</a></li>
			<li class="nav-item"><a href="rooms.php" class="nav-link menu-item border-right mr-2"><i
						class="bi bi-shop"></i> Δωμάτια</a></li> -->
<?php
// if (isset($_SESSION['loggedin'])) {
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="POST">
					...
					<div class="text-center ">
						<button type="submit" name="submit" id="loginbtn" class="btn  btn-block text-white"
							value="Login" style="background-color: #ff9900;" onclick="login()">Σύνδεση</button>
			...
			<div class="d-flex justify-content-center">
				<div class="modal-footer">
					<p>Νέος χρήστης; <a href="" data-toggle="modal" data-target="#exampleModal2"
							data-dismiss="modal">Γίνε μέλος</a></p>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="form2" method="post">
					<div class="form-group">
						<input onkeypress="return /[a-zα-ω]/i.test(event.key)" required type="text" class="form-control"
							id="registerInputName" name="fname" placeholder="Όνομα">
					</div>
					<div class="form-group">
						<input onkeypress="return /[a-zα-ω]/i.test(event.key)" required type="text" class="form-control"
							id="registerInputSname" name="sname" placeholder="Επίθετο">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<input onkeypress="return /[a-zα-ω0-9]/i.test(event.key)" required type="text"
							class="form-control" id="registerInputAddress" name="address" placeholder="Διεύθυνση">
					</div>
					<div class="form-group">
						<input required type="email" class="form-control" id="registerInputEmail" name="email"
							placeholder="Email">
					</div>
					<div class="form-group">
						<input onkeypress="return /[a-zα-ω0-9]/i.test(event.key)" required type="text"
							class="form-control" id="registerInputUsername" name="uname" placeholder="Όνομα χρήστη">
					</div>
					<div class="form-group">
						<input onkeypress="return /[0-9]/i.test(event.key)" minlength="10" maxlength="10" required
							type="text" class="form-control" id="registerInputTel" name="tel"
							placeholder="Αριθμός Τηλεφώνου">
					</div>
					<div class="form-group">
						<input required type="password" minlength="6" class="form-control" id="registerInputPassword"
							name="password" placeholder="Συνθηματικό">
					</div>
					<div class="form-group">
						<input required type="password" minlength="6" onfocusout="matchPassword()" class="form-control"
							id="registerInputPasswordcheck" name="cpassword" placeholder="Επιβεβαίωση Συνθηματικού">
						<p id="alert" class="text-danger"></p>
					</div>
					<div class="text-center">
						<button required type="submit" class="btn  btn-block text-white" id="registerbtn"
							style="background-color: #ff9900;" onclick="signup()">Εγγραφή</button>
					</div>
				</form>
			</div>
			...
			<div class="d-flex justify-content-center">
				<div class="modal-footer">
					<p>Είσαι ήδη μέλος; <a href="" data-toggle="modal" data-target="#exampleModal"
							data-dismiss="modal">Συνδέσου</a></p>
				</div>
			</div>
		</div>
	</div>
