...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
	<a class="navbar-brand" href="admin.php">Admin Hotel <i class="bi bi-code-slash"></i></a>
				...
				<form method="POST">
					...
					<div class="text-center ">
						<button type="submit" name="submit" id="loginbtn" class="btn  btn-block text-white"
							value="Login" style="background-color: #ff9900;" onclick="adminlogin()">Σύνδεση</button>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="createRoom.php" id="form2" method="post">
					<div class="form-group">
						<input required type="text" class="form-control" id="roomName" name="roomName"
					...
					<div class="form-group">
						<input required type="text" class="form-control" id="image" name="image"
							placeholder="Φωτογραφία">
					</div>
					<div class="form-group">
						<input onkeypress="return /[0-9]/i.test(event.key)" required type="text" class="form-control"
							id="price" name="price" placeholder="Τιμή">
					</div>
					<div class="form-group">
						<input onkeypress="return /[0-9]/i.test(event.key)" required type="text" class="form-control"
							id="numberOfGuests" name="numberOfGuests" placeholder="Αριθμός ατόμων">
					</div>
					<div class="form-group">
					...
					<div class="text-center">
						<button required type="submit" class="btn  btn-block text-white" id="createbtn"
							style="background-color: #ff9900;">Δημιουργία</button>
					</div>
				</form>
			</div>
