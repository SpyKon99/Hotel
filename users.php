...
<body class="bg-light">
    ...
    <div class="d-flex justify-content-center"><button class="btn btn-primary btn-lg" data-toggle="modal"
            data-target="#exampleModal2" style="border:none;"><i class="bi bi-plus"></i></button></div>
    <br />
